...
\begin{figure}[h]
       \centering
        \includegraphics[width=1\linewidth]{figs/plot1.png} % Adjust the width as needed
        \caption{}
\end{figure}

\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/plot2.png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/plot3.png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h] 
      \centering
       \includegraphics[width=1\linewidth]{figs/plot4.png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/plot5.png} % Adjust the width as needed
        \caption{}
\end{figure}
