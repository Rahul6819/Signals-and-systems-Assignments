...
\begin{figure}[h]
       \centering
        \includegraphics[width=1\linewidth]{figs/download.png} % Adjust the width as needed
        \caption{}
\end{figure}

\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/download (1).png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/download (2).png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h] 
      \centering
       \includegraphics[width=1\linewidth]{figs/download (3).png} % Adjust the width as needed
        \caption{}
    \end{figure}
    
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/download (4).png} % Adjust the width as needed
        \caption{}
\end{figure}
